...
public class UplodePaymentActivity extends AppCompatActivity {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            downloadUri.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    upload_payment(id_user,id_add,name_event,photoStringLink,date,time,bank);
    ...
    private void upload_payment(final int id_user, final int id_add,String name_event, String photoStringLink, String date, String time, String bank){
        ...
        Call<ResultQuery> call = service.upload_payment(new UploadPaymentDB(id_user,id_add,name_event,first_name,last_name,photoStringLink,date,time,bank));
